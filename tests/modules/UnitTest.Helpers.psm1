function Set-MockEnvironment {
    ...
    $ENV:deployOperationalLogAnalyticsWorkspace = "Disabled"
    $ENV:deploySecurityLogAnalyticsWorkspace = "Disabled"
    ...
    $ENV:securityLogAnalyticsTableNames = "AZKVAuditLogs,AzureActivity"
...
function Clear-MockEnvironment {
    ...
    Remove-Item -Path @(
        ...
        "ENV:deployOperationalLogAnalyticsWorkspace",
        "ENV:deploySecurityLogAnalyticsWorkspace",
